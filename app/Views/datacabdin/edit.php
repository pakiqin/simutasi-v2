...
<div class="container">
    <h1 class="mb-4"><i class="fas fa-building"></i> Edit Cabang Dinas</h1>
    ...
    <form action="/cabang-dinas/update/<?= $cabang_dinas['id'] ?>" method="post" onsubmit="return validateForm()">
        <div class="row">
            <!-- Bagian Kiri -->
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="kode_cabang" id="kode_cabang" class="form-control"
                               value="<?= $cabang_dinas['kode_cabang']; ?>" readonly>
                    </div>
                </div>
                <div class="form-group mb-3">
                            ...
                            <?php foreach ($kabupaten as $kab): ?>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="id_kab[]" id="kab_<?= $kab['id_kab'] ?>" value="<?= $kab['id_kab'] ?>"
                                        <?= in_array($kab['id_kab'], $selected_kabupaten) ? 'checked' : ''; ?>>
