...
<div class="d-flex justify-content-between align-items-center mb-3">
    <a href="/operatorcabdin/create" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Tambah Akun Operator Cabdin</a>
    ...
    <tbody>
        <?php $no = 1; foreach ($users as $user): ?>
            <tr>
                ...
                <td><?= $user['no_hp'] ?></td>     
                <td>
                    <a href="/operatorcabdin/edit/<?= $user['id'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
