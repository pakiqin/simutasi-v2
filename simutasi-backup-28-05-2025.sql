...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Bulan Mei 2025 pada 11.20
...
--
-- Struktur dari tabel `info_pengembangan`
--

CREATE TABLE `info_pengembangan` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `info_pengembangan`
--

INSERT INTO `info_pengembangan` (`id`, `judul`, `deskripsi`, `tanggal`, `status`) VALUES
(20, 'Optimalisasi Proses Input Usulan Mutasi Guru', '<p data-start=\"156\" data-end=\"409\"><strong data-start=\"156\" data-end=\"170\">Deskripsi:</strong><br data-start=\"170\" data-end=\"173\">Sebelum pengembangan, proses input usulan dilakukan dalam satu halaman yang mencakup input data guru, sekolah, serta berkas usulan. Hal ini meningkatkan risiko kesalahan penyimpanan data akibat beban input yang besar dalam satu tahap.</p><p data-start=\"411\" data-end=\"574\">Setelah pengembangan, proses input usulan dioptimalkan menjadi dua tahap:<br data-start=\"484\" data-end=\"487\">1️⃣ <strong data-start=\"491\" data-end=\"502\">Tahap 1</strong> – Input data guru dan sekolah<br data-start=\"532\" data-end=\"535\" data-is-only-node=\"\">2️⃣ <strong data-start=\"539\" data-end=\"550\">Tahap 2</strong> – Input berkas usulan</p><p data-start=\"576\" data-end=\"777\"><strong data-start=\"576\" data-end=\"588\">Manfaat:</strong><br data-start=\"588\" data-end=\"591\">✅ Meminimalkan risiko kesalahan dalam penyimpanan data<br data-start=\"645\" data-end=\"648\">✅ Mempermudah validasi dan koreksi sebelum mengunggah berkas<br data-start=\"708\" data-end=\"711\" data-is-only-node=\"\">✅ Meningkatkan kecepatan dan efisiensi dalam proses input usulan</p>', '2025-03-04 09:30:59', 'public'),
(21, 'Peningkatan Validasi Input NIP dan NIK pada Usulan Mutasi', '<p data-start=\"168\" data-end=\"459\"><strong data-start=\"168\" data-end=\"182\">Deskripsi:</strong><br data-start=\"182\" data-end=\"185\">Sebelum pengembangan, input NIP dan NIK tidak memiliki validasi yang ketat sehingga memungkinkan pengguna memasukkan data yang tidak sesuai format atau mengajukan usulan dengan data yang sudah ada dalam proses. Hal ini berpotensi menyebabkan duplikasi atau kesalahan data.</p><p data-start=\"461\" data-end=\"753\">Setelah pengembangan, sistem telah menerapkan validasi ketat:<br data-start=\"522\" data-end=\"525\">✅ NIP harus terdiri dari <strong data-start=\"550\" data-end=\"568\">18 digit angka</strong><br data-start=\"568\" data-end=\"571\">✅ NIK harus terdiri dari <strong data-start=\"596\" data-end=\"614\">16 digit angka</strong><br data-start=\"614\" data-end=\"617\" data-is-only-node=\"\">✅ Hanya angka yang dapat dimasukkan (tidak bisa huruf atau karakter lain)<br data-start=\"690\" data-end=\"693\">✅ Cek ketersediaan NIP/NIK untuk mencegah duplikasi usulan</p><p data-start=\"755\" data-end=\"943\"><strong data-start=\"755\" data-end=\"767\">Manfaat:</strong><br data-start=\"767\" data-end=\"770\">✅ Memastikan keakuratan data guru dalam sistem<br data-start=\"816\" data-end=\"819\">✅ Mencegah pengajuan usulan ganda dengan data yang sama<br data-start=\"874\" data-end=\"877\">✅ Mengurangi kesalahan input yang dapat menghambat proses mutasi</p>', '2025-03-05 09:33:20', 'public');
...
(54, 'CD012202503040001', 'CD012202503040001-rekomendasicabdin.pdf', 'pakiqin', '085358207706', '2025-03-04 09:42:50', '2025-03-04 16:43:59', 'Lengkap', '', 'Disetujui', 'Usulan mutasi memenuhi syarat', '2025-03-04 02:43:59'),
(59, 'CD001202503100001', 'CD001202503100001-rekomendasicabdin.pdf', 'pakiqin', '085358207706', '2025-03-11 09:39:29', '2025-03-11 09:39:29', 'Terkirim', '-', NULL, NULL, NULL);
...
(18, 'REKOM-1741021238', '2025-03-03', 'Perihal Otomatis', 'CD006202503030001-rekomkadis.pdf', '2025-03-03 17:00:38', '2025-03-03 17:00:38'),
(19, 'REKOM-1741080260', '2025-03-04', 'Perihal Otomatis', 'CD015202503030001-rekomkadis.pdf', '2025-03-04 09:24:20', '2025-03-04 09:24:20'),
(20, 'REKOM-1741081546', '2025-03-04', 'Perihal Otomatis', 'CD012202503040001-rekomkadis.pdf', '2025-03-04 09:45:46', '2025-03-04 09:45:46');

-- --------------------------------------------------------

--
-- Struktur dari tabel `saran_mutasi`
--

CREATE TABLE `saran_mutasi` (
  `id` int(11) NOT NULL,
  `nomor_usulan` varchar(50) NOT NULL,
...
--
-- Dumping data untuk tabel `saran_mutasi`
--

INSERT INTO `saran_mutasi` (`id`, `nomor_usulan`, `email`, `saran`, `balasan`, `status`, `created_at`, `updated_at`) VALUES
(2, 'CD006202503050001', 'xiqinx@gmail.com', 'test aja', NULL, 'Belum Dibalas', '2025-03-08 18:00:16', '2025-03-08 19:12:24'),
(3, 'CD006202503050001', 'xiqinx@gmail.com', 'test lagi', 'test apakah masuk', 'Sudah Dibalas', '2025-03-08 18:00:35', '2025-03-08 12:16:26'),
(4, 'CD006202503050001', 'iqinblog@gmail.com', 'testlagi', 'test balas email apakah masuk', 'Sudah Dibalas', '2025-03-08 18:08:00', '2025-03-08 12:13:05'),
(5, 'CD006202503100001', 'xiqinx@gmail.com', 'test aja ya', 'iya', 'Sudah Dibalas', '2025-03-12 08:41:52', '2025-03-12 22:24:54'),
(6, 'CD006202503100001', 'xiqinx@gmail.com', 'test', NULL, 'Belum Dibalas', '2025-03-12 09:05:39', '2025-03-11 08:12:33'),
(7, 'CD006202503050001', 'pakiqin@gmail.com', 'Saya menyadari bahwa setiap tahapan dalam proses mutasi membutuhkan waktu dan prosedur yang harus diikuti. Namun, saya ingin menanyakan apakah ada cara agar proses ini dapat dipercepat, mengingat kebutuhan mendesak untuk segera berpindah ke sekolah tujuan. Jika ada syarat tambahan atau langkah administratif yang perlu saya lakukan, mohon arahannya agar saya dapat segera menyelesaikannya', 'Terima kasih atas pertanyaan dan kesabaran Bapak danIbu dalam menunggu proses mutasi. Kami memahami bahwa setiap pengusul memiliki kebutuhan yang berbeda, termasuk kebutuhan mendesak untuk segera berpindah ke sekolah tujuan. Saat ini, proses mutasi masih mengikuti tahapan yang telah ditetapkan sesuai dengan regulasi yang berlaku.\n\nJika ingin mempercepat proses, Bapak/Ibu dapat memastikan bahwa semua dokumen yang dibutuhkan sudah lengkap dan sesuai dengan persyaratan. Selain itu, mohon pastikan bahwa usulan sudah mendapat persetujuan dari pihak terkait, seperti sekolah asal, sekolah tujuan, dan dinas pendidikan setempat. Jika ada dokumen tambahan yang diperlukan, kami akan segera menginformasikannya.\n\nSilakan cek kembali status usulan melalui sistem, dan jika ada hal yang perlu dikonfirmasi lebih lanjut, Bapak/Ibu dapat menghubungi kami. Kami akan berusaha membantu agar proses berjalan seefisien mungkin. Terima kasih.', 'Sudah Dibalas', '2025-03-12 21:23:36', '2025-03-13 14:11:09'),
(8, 'CD001202503100001', 'xiqinx@gmail.com', 'test aja', NULL, 'Belum Dibalas', '2025-03-20 22:40:31', '2025-03-20 22:40:31');
...
(15, 'CD006202503030001', '8765', 'Nota Dinas', '2025-03-04', 'CD006202503030001-20250304.pdf', '2025-03-03 17:03:16', '2025-03-04 00:03:16'),
(16, 'CD015202503030001', '8765', 'SK Mutasi', '2025-03-18', 'CD015202503030001-20250318.pdf', '2025-03-04 09:34:31', '2025-03-04 16:34:31');
...
(3, 'admin', 'pakiqin', 'pakiqin@gmail.com', '085358207706', '$2y$10$LdcGulUcIWVSgqe3NILbUe9Dc2RVBNg7UOENScrjVV8Xl0OpbgoJG', 'admin', '2025-01-09 11:20:40', '2025-05-28 01:45:23', 'enable', 0, '2025-05-28 01:45:05'),
...
(195, 3, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:29:21'),
(196, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:29:33'),
(197, 3, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:29:46'),
(198, 8, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:29:56'),
(199, 8, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:30:07'),
(200, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:30:27'),
(201, 21, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:31:02'),
(202, 21, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:31:05'),
(203, 47, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:31:14'),
(204, 47, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:31:16'),
(205, 21, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:34:11'),
(206, 21, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:34:31'),
(207, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:38:32'),
(208, 3, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:40:48'),
(209, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:40:57'),
(210, 3, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:42:08'),
(211, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:42:21'),
(212, 3, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:43:10'),
(213, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-07 14:43:30'),
(214, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-08 16:36:22'),
(215, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 07:45:52'),
(216, 3, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 07:46:25'),
(217, 42, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 07:46:34'),
(218, 42, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 08:35:57'),
(219, 47, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 08:36:05'),
(220, 47, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 08:42:46'),
(221, 47, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 08:42:54'),
(222, 47, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 08:54:04'),
(223, 42, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 08:54:12'),
(224, 42, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 09:04:41'),
(225, 47, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 09:04:50'),
(226, 47, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 09:12:58'),
(227, 47, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 09:13:07'),
(228, 47, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 09:13:25'),
(229, 42, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 09:13:35'),
(230, 42, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 09:18:23'),
(231, 47, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 09:18:31'),
(232, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-10 09:30:36'),
(233, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-11 09:32:40'),
(234, 3, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-11 09:33:20'),
(235, 8, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-11 09:33:28'),
(236, 8, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-11 09:39:12'),
(237, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-11 09:39:19'),
(238, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-12 15:08:11'),
(239, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-13 03:24:04'),
(240, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-13 05:18:03'),
(241, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-13 07:15:01'),
(242, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-13 13:58:12'),
(243, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-15 19:20:04'),
(244, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-16 05:54:09'),
(245, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-16 06:14:16'),
(246, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-19 13:26:56'),
(247, 47, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-20 17:31:28'),
(248, 47, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-20 18:31:15'),
(249, 8, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-20 18:31:23'),
(250, 8, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-20 18:31:58'),
(251, 25, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-20 18:32:06'),
(252, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-21 05:37:31'),
(253, 3, 'logout', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36', '2025-03-21 05:41:17'),
(254, 3, 'login', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/136.0.0.0 Safari/537.36', '2025-05-28 08:45:23');
...
(115, '11111111111111', '111111111111111111', '1111111111111111', 'SMAN 1 DARUL HASANAH', 'SMAN 1 TAMIANG HULU', '1. Merawat Orang tua yang telah lanjut usia dan perlu kontrol tiap bulan pada polik jantung\n2. Mengurus keluarga: 3 (tiga) orang anak dalam pendidikan SD dan SMP serta Istri yang bertugas di sekolah dengan kepangkatan IV/a dan sudah sertifikasi\n3. Ingin mengabdi di daerah asal\n4. Mengisi kekurangan Tenaga Fungsional (Guru PAI) yang kuran pada seklah tujuan\n5. kekurangan jam sertifikasi sebanyak 6 jam di sekolah asal', NULL, 'CD012202503040001', '05', '2025-03-04 09:39:50', '2025-03-13 07:14:37', 15, 20, NULL, NULL),
(118, 'Test 2', '222222222222222222', '2222222222222222', 'SMAN 1 SINGKOHOR', 'SMA NEGERI 1 TERANGUN', '222', NULL, 'CD020202503040001', '01', '2025-03-04 20:51:04', '2025-03-04 20:51:04', 31, NULL, NULL, NULL),
(119, '33', '333333333333333333', '3333333333333333', 'SLB Negeri Aceh Selatan', 'SMA NEGERI 1 DEWANTARA', '33333', NULL, 'CD018202503040001', '01', '2025-03-04 20:57:47', '2025-03-04 20:57:47', 22, NULL, NULL, NULL),
(121, 'Test 11', '444444444444444444', '4444444444444444', 'SMK NEGERI 1 BAKTIYA', 'SMAN 1 TAMIANG HULU', 'EMPAT', NULL, 'CD006202503050001', '01', '2025-03-05 06:52:58', '2025-03-05 08:52:52', 9, NULL, NULL, NULL),
(122, 'ubah 1', '121212121212122111', '1212121212121221', 'SMA NEGERI 1 DARUSSALAM', 'SMA NEGERI UNGGUL HARAPAN PERSADA', 'ubah 1', NULL, 'CD001202503100001', '02', '2025-03-10 09:18:06', '2025-03-11 02:39:29', 3, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `usulan_drive_links`
--

CREATE TABLE `usulan_drive_links` (
  `id` int(11) NOT NULL,
  `nomor_usulan` varchar(50) NOT NULL,
...
--
-- Dumping data untuk tabel `usulan_drive_links`
--

INSERT INTO `usulan_drive_links` (`id`, `nomor_usulan`, `drive_link`, `created_at`) VALUES
(41, 'CD012202503040001', 'https://drive.google.com/file/d/19qTrmJVIye0u9Q0zWYC-bgYiSnjbAvoD/view?usp=drive_link', '2025-03-04 02:42:05'),
(42, 'CD012202503040001', 'https://drive.google.com/file/d/1iWiAmCNMxv1fUdMU-5imed8CaBTV-usc/view?usp=drive_link', '2025-03-04 02:42:05'),
(43, 'CD012202503040001', 'https://drive.google.com/file/d/19qTrmJVIye0u9Q0zWYC-bgYiSnjbAvoD/view?usp=drive_link', '2025-03-04 02:42:05'),
(317, 'CD012202503040001', '03', '2025-03-04 02:43:00', 'Proses Verifikasi Berkas di Dinas Provinsi (Lengkap). '),
(318, 'CD012202503040001', '04', '2025-03-04 02:43:59', 'Telaah Usulan oleh Kepala Bidang GTK (Disetujui). Usulan mutasi memenuhi syarat'),
(319, 'CD012202503040001', '05', '2025-03-04 09:45:46', 'Penerbitan surat rekomendasi Kepala Dinas'),
(322, 'CD020202503040001', '01', '2025-03-04 13:51:04', 'Input data guru dan sekolah oleh Cabang Dinas'),
(323, 'CD018202503040001', '01', '2025-03-04 13:57:47', 'Input data guru dan sekolah oleh Cabang Dinas'),
(325, 'CD006202503050001', '01', '2025-03-04 23:52:58', 'Input data guru dan sekolah oleh Cabang Dinas'),
(326, 'CD006202503050001', '02', '2025-03-04 23:53:12', 'Berkas usulan mutasi telah dikirim ke Dinas Provinsi'),
(327, 'CD006202503050001', '02', '2025-03-04 23:54:00', 'Proses Verifikasi Berkas di Dinas Provinsi (TdkLengkap). berkas tidak lengkap'),
(328, 'CD006202503050001', '01', '2025-03-05 00:08:04', 'Data usulan mutasi dilakukan revisi oleh Cabang Dinas'),
(329, 'CD006202503050001', '02', '2025-03-05 00:09:04', 'Berkas usulan mutasi telah dikirim ke Dinas Provinsi'),
(330, 'CD006202503050001', '02', '2025-03-05 00:09:20', 'Proses Verifikasi Berkas di Dinas Provinsi (TdkLengkap). pokoknya harus revisi'),
(331, 'CD006202503050001', '01', '2025-03-05 00:09:39', 'Data usulan mutasi dilakukan revisi oleh Cabang Dinas'),
(332, 'CD006202503050001', '02', '2025-03-05 01:52:22', 'Berkas usulan mutasi telah dikirim ke Dinas Provinsi'),
(333, 'CD006202503050001', '02', '2025-03-05 01:52:37', 'Proses Verifikasi Berkas di Dinas Provinsi (TdkLengkap). test revisi'),
(334, 'CD006202503050001', '01', '2025-03-05 01:52:52', 'Data usulan mutasi dilakukan revisi oleh Cabang Dinas'),
(335, 'CD001202503100001', '01', '2025-03-10 02:18:06', 'Input data guru dan sekolah oleh Cabang Dinas'),
(340, 'CD001202503100001', '02', '2025-03-11 02:39:29', 'Berkas usulan mutasi telah dikirim ke Dinas Provinsi');
...
--
-- Indeks untuk tabel `info_pengembangan`
--
ALTER TABLE `info_pengembangan`
  ADD PRIMARY KEY (`id`);
...
--
-- Indeks untuk tabel `saran_mutasi`
--
ALTER TABLE `saran_mutasi`
  ADD PRIMARY KEY (`id`);
...
--
-- Indeks untuk tabel `usulan_drive_links`
--
ALTER TABLE `usulan_drive_links`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT untuk tabel `info_pengembangan`
--
ALTER TABLE `info_pengembangan`
...
--
-- AUTO_INCREMENT untuk tabel `saran_mutasi`
--
ALTER TABLE `saran_mutasi`
...
--
ALTER TABLE `sk_mutasi`
  MODIFY `id_skmutasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
-- AUTO_INCREMENT untuk tabel `usulan_drive_links`
--
ALTER TABLE `usulan_drive_links`
...
--
-- Ketidakleluasaan untuk tabel `usulan_drive_links`
--
ALTER TABLE `usulan_drive_links`
  ADD CONSTRAINT `usulan_drive_links_ibfk_1` FOREIGN KEY (`nomor_usulan`) REFERENCES `usulan` (`nomor_usulan`);
